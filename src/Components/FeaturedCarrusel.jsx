...
// funciona excelente con la descripcion cortada pero sin tiptap
...
//                                     <Rating value={item.rating || 4} readOnly size="small" sx={{ mt: 1 }} />
...
// // Componente para la descripción con "Leer más"
// const DescriptionToggle = ({ description }) => {
//     const [isExpanded, setIsExpanded] = useState(false);
//     const truncatedDescription = description?.substring(0, 100); // Limita a 100 caracteres
...
// funciona y toma datos  del editor de tiptap
import { useState, useEffect } from "react";
import api from '../Services/Api.js';
import { useNavigate } from "react-router-dom";
import { Swiper, SwiperSlide } from "swiper/react";
...
// Helper para truncar HTML sin romper etiquetas
...
// Componente para la descripción con HTML y "Leer más"
const DescriptionToggle = ({ description }) => {
    const [isExpanded, setIsExpanded] = useState(false);
